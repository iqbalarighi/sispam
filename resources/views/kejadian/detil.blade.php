...
@endif
                ...
                @else
                    <div align="center" class="mb-2">
                       <a target="_blank" href="https://wa.me/62811163361?text=Assalamualaikum%20Pak%2C%20mohon%20izin%20untuk%20memberikan%20persetujuan%20pada%20dokumen%20izin%20kerja%20dengan%20nomor%20{{$detil->izin_id}}.%20Terima%20Kasih.%0A%0Ahttps%3A%2F%2Fwww.sispam.id%2Fizin-detail%2F{{$detil->id}}"><span class="bg-success text-white rounded fw-bold py-1 px-2">Nanang Arianto</span></a>
                       <a target="_blank" href="https://wa.me/628128051226?text=Assalamualaikum%20Pak%2C%20mohon%20izin%20untuk%20memberikan%20persetujuan%20pada%20dokumen%20izin%20kerja%20dengan%20nomor%20{{$detil->izin_id}}.%20Terima%20Kasih.%0A%0Ahttps%3A%2F%2Fwww.sispam.id%2Fizin-detail%2F{{$detil->id}}"><span class="bg-success text-white rounded fw-bold py-1 px-2">Tomi Hartono</span></a>
                       <a target="_blank" href="https://wa.me/6281253005354?text=Assalamualaikum%20Pak%2C%20mohon%20izin%20untuk%20memberikan%20persetujuan%20pada%20dokumen%20izin%20kerja%20dengan%20nomor%20{{$detil->izin_id}}.%20Terima%20Kasih.%0A%0Ahttps%3A%2F%2Fwww.sispam.id%2Fizin-detail%2F{{$detil->id}}"><span class="bg-success text-white rounded fw-bold py-1 px-2">Budi Murtopo</span></a>
                    </div>
                @endif
                @endif
